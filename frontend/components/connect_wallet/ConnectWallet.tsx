...
function ConnectWallet() {
  const { address, setAddress, provider, setProvider, setWallet, fuelInstalled, setFuelInstalled, setGameID, isConnected, setConnected, connect, disconnect } = useContext(WalletContext)
